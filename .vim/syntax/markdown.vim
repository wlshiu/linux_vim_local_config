...
hi ItemSymbol    ctermfg=10  cterm=none

"highlighting for Markdown groups
HtmlHiLink mkdString        String
HtmlHiLink mkdCode          Type "String
HtmlHiLink mkdCodeStart     Type "String
HtmlHiLink mkdCodeEnd       Type "String
HtmlHiLink mkdFootnote      Special " Comment
HtmlHiLink mkdBlockquote    Special " Comment
HtmlHiLink mkdListItem      ItemSymbol " Identifier
