...
hi def Italic                       term=italic cterm=italic gui=italic ctermfg=118
hi def Bold                         term=bold cterm=bold gui=bold ctermfg=118
hi def BoldItalic                   term=bold,italic cterm=bold,italic gui=bold,italic ctermfg=118
...
hi def link markdownInlineCode              Constant "String"
hi def link markdownFencedCodeBlock         Type " String"
hi def link markdownCodeBlock               Type " String"
