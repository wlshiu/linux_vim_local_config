...
function! <SID>DoxygenLicenseFunc()
  ...
  let l:fileName = expand('%:t') "// Get file name//"

  let l:year = strftime("%Y")
  let l:copyright = "Copyright (c) "
  " let l:copyright = l:copyright.strftime("%Y").", ".g:DoxygenToolkit_companyName." All Rights Reserved.\<enter>"
  let l:copyright = l:copyright.strftime("%Y").", ".g:DoxygenToolkit_authorName." All Rights Reserved.\<enter>"
  let l:copyright = substitute( l:copyright, "\<enter>", "\<enter>".s:interCommentBlock, "g" )
  ...
  exec "normal o".s:interCommentTag.l:copyright
  ...
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_versionTag."0.1"
  let l:date = strftime("%Y-%m-%d")
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_dateTag.l:date
  exec "normal o".s:interCommentTag.l:license
  exec "normal o".s:interCommentTag.g:DoxygenToolkit_descriptionTag
